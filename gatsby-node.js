  ...
  return new Promise((resolve, reject) => {
    ...
    graphql(
      ...
      .then(result => {
        ...
        const eventsUnderContentTemplate = path.resolve("./src/templates/eventsUnderContent.js")
        ...
        _.each(result.data.allWordpressPage.edges, edge => {
          ...
          createPage({
            ...
            path: `/${edge.node.slug}/`,
            component: slash(edge.node.template === 'events_under_content.php' ? eventsUnderContentTemplate : pageTemplate),
            context: edge.node,
          })
        })
      })
